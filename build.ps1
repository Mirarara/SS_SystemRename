...
$jarPath = Join-Path $modRoot "jars\SystemNameRename.jar"
$sourcePath = Join-Path $modRoot "src\systemnamerename\rulecmd\SystemNameRename.java"
...
& (Join-Path $jdkPath "java.exe") -ea -cp "$classesPath;$(Join-Path $corePath 'starfarer.api.jar')" systemnamerename.rulecmd.SystemNameRename
